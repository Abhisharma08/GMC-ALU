      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-2 opacity-80">Plot No. 10, 2nd Floor, Street No. 2, Pali Road,</p>
            <p className="text-sm mb-2 opacity-80">Bhakri, Near Asharam Bapu Ashram,</p>
            ...
            <p className="text-sm mb-2 opacity-80 flex items-center">
              ...
              <span className="hover:text-orange-500 transition">info@aluempire.com</span>
            </p>

            <p className="text-sm opacity-80 flex items-center">
              <span className="font-semibold text-orange-500 mr-2">Phone:</span> 
              <span className="hover:text-orange-500 transition">+91 9002690068</span>
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm opacity-80 leading-relaxed">
              We specialize in delivering high-quality UPVC and aluminum solutions that enhance the aesthetic and functional value of both residential and commercial spaces.
            </p>
          </div>
        </div>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 text-center text-sm opacity-60">
          ...
          <span className="text-orange-500 font-medium"> Alu Empire</span>. All rights reserved.
        </div>
      </div>
    </footer>
  );
